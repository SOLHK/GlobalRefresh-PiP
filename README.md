...
> STRA刷新 2.0.0 起由 [SOLHK](https://github.com/SOLHK/GlobalRefresh-PiP) 独立维护；原始项目及后续贡献者的开源署名保留。
...
本项目基于 CaiWanFeng 的 PiP 示例与 Yoroin 的 GlobalRefresh-PiP 继续开发。STRA刷新 2.0.0 由 SOLHK 独立维护，延续画中画与刷新率实验功能，并持续调整锁屏节能、过热恢复及界面布局。原始作者与贡献者的开源署名详见 NOTICE。
